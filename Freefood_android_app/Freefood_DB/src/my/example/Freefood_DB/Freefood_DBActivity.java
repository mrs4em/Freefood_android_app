...
public class Freefood_DBActivity extends Activity {
    ...
    //setListAdapter(new ArrayAdapter<String>(this,R.layout.home_page, event_name));
    //ListView lv;
//lv = getListView();
      ListView listview = (ListView) findViewById(R.id.mylist);
      ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,event_name);
